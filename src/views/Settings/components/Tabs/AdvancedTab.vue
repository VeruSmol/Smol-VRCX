<template>
  <div class="flex flex-col gap-10 py-2">
    <SettingsGroup
      :title="t('view.settings.advanced.advanced.vrchat_settings.header')"
    >
      <SettingsItem
        :label="t('view.settings.advanced.advanced.relaunch_vrchat.header')"
        :description="
          t('view.settings.advanced.advanced.relaunch_vrchat.description')
        "
      >
        <Switch
      ...
      <SettingsItem
        ...
        :description="
          t('view.settings.advanced.advanced.vrchat_quit_fix.description')
        "
      >
      ...
      <SettingsItem
        ...
        "
        :description="
          t('view.settings.advanced.advanced.auto_cache_management.description')
        "
      >
        <Switch
      ...
      <SettingsItem
        ...
        :description="
          t('view.settings.advanced.advanced.self_invite.description')
        "
      >
        <Switch
      ...
      <!-- [smol] - advanced setting for keeping the watcher alive after closing the dialog -->
      <SettingsItem
        :label="
          t(
            'view.settings.advanced.advanced.smol_keep_watching_after_close.header',
          )
        "
        :description="
          t(
            'view.settings.advanced.advanced.smol_keep_watching_after_close.description',
          )
        "
      >
        <Switch
          :model-value="smolKeepWatchingAfterDialogClose"
    ...
    <SettingsGroup :title="t('view.settings.advanced_groups.security.header')">
      <SettingsItem
        ...
        :description="
          t('view.settings.advanced.advanced.primary_password.description')
        "
      >
        <Switch
    ...
    <SettingsGroup :title="t('view.settings.general.logging.header')">
      ...
      >
        <Button
          size="sm"
          variant="outline"
          @click="promptAutoLoginDelaySeconds"
        >
    ...
    <template v-if="!isLinux">
      <SettingsGroup
        :title="t('view.settings.advanced.advanced.app_launcher.header')"
      >
        <SettingsItem
          :label="t('view.settings.advanced.advanced.app_launcher.folder')"
        >
        ...
        <SettingsItem
          ...
          :description="
            t('view.settings.advanced.advanced.app_launcher.folder_tooltip')
          "
        >
          <Switch
        ...
        <SettingsItem
          :label="
            t('view.settings.advanced.advanced.app_launcher.run_process_once')
          "
        >
          <Switch
    ...
    <SettingsGroup
      :title="t('view.settings.advanced.advanced.launch_commands.header')"
    >
      <SettingsItem
        :label="
          t(
      ...
      <div class="flex gap-2">
        <Button
          ...
          @click="
            openExternalLink(
              'https://github.com/vrcx-team/VRCX/wiki/Launch-parameters-&-VRCX.json',
            )
          "
          >{{
    ...
    <SettingsGroup
      :title="t('view.settings.advanced.advanced.cache_debug.header')"
    >
      <div class="flex gap-2 flex-wrap">
        ...
        <Button
          size="sm"
          variant="outline"
          @click="promptAutoClearVRCXCacheFrequency"
          >{{
      ...
      <SettingsItem
        :label="t('view.settings.advanced.advanced.cache_debug.show_console')"
      >
    ...
    <SettingsGroup :title="t('view.settings.advanced_groups.database.header')">
      <SettingsItem
        :label="t('view.settings.advanced.advanced.sqlite_table_size.refresh')"
      >
      ...
      <SettingsItem
        :label="
          t('view.settings.advanced.advanced.database_cleanup.auto_cleanup')
        "
        :description="
          t(
        ...
        >
          ...
          <SelectContent>
            <SelectGroup>
              ...
              <SelectItem value="30">{{
                t(
                  "view.settings.advanced.advanced.database_cleanup.auto_cleanup_30",
                )
              }}</SelectItem>
              <SelectItem value="90">{{
                t(
                  "view.settings.advanced.advanced.database_cleanup.auto_cleanup_90",
                )
              }}</SelectItem>
              <SelectItem value="180">{{
                t(
                  "view.settings.advanced.advanced.database_cleanup.auto_cleanup_180",
                )
              }}</SelectItem>
              <SelectItem value="365">{{
                t(
                  "view.settings.advanced.advanced.database_cleanup.auto_cleanup_365",
                )
              }}</SelectItem>
            </SelectGroup>
          </SelectContent>
      ...
      <SettingsItem
        :label="
          t('view.settings.advanced.advanced.database_cleanup.purge_button')
        "
      >
        <Button
          size="sm"
          variant="outline"
          @click="isPurgeDialogVisible = true"
        >
      ...
      <DialogContent class="x-dialog sm:max-w-md">
        ...
        <DialogFooter>
          <Button
            variant="outline"
            size="sm"
            @click="isPurgeDialogVisible = false"
          >
    ...
    >
      ...
      <SettingsGroup :title="t('view.profile.config_json')">
        <div class="flex items-center gap-2">
          <TooltipWrapper
            side="top"
            :content="t('view.profile.refresh_tooltip')"
          >
            <Button
              class="rounded-full"
              size="icon-sm"
    ...
    <template v-if="branch === 'Nightly'">
      <SettingsGroup :title="t('view.settings.advanced_groups.nightly.header')">
        <SettingsItem
          :label="
            t(
              'view.settings.advanced.advanced.anonymous_error_reporting.header',
            )
          "
          :description="
            t(
              'view.settings.advanced.advanced.anonymous_error_reporting.description',
            )
          "
        >
          <Switch
            :model-value="sentryErrorReporting"
            @update:modelValue="setSentryErrorReporting()"
          />
        </SettingsItem>
      </SettingsGroup>
    </template>
...
// [smol] - local editable copy for numeric input
const smolInstancePollSecondsInput = ref(smolInstancePollSeconds.value);
...
// [smol] - keep input in sync if the setting changes elsewhere
watch(
  smolInstancePollSeconds,
  (value) => {
    smolInstancePollSecondsInput.value = value;
  },
  { immediate: true },
);

// [smol] - persist numeric input with same bounds as coordinator
function updateSmolInstancePollSeconds() {
  let nextValue = Number(smolInstancePollSecondsInput.value);
