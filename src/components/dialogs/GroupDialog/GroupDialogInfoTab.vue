  ...
  <div class="flex flex-wrap items-start px-2.5" style="max-height: none">
      ...
      <div class="flex-1 overflow-hidden">
        ...
        >
          <img
            ...
            "
            @click="
              showFullscreenImageDialog(groupDialog.announcement.imageUrl)
            "
        ...
        >
          <TooltipWrapper
            v-if="groupDialog.announcement.roleIds.length"
            side="top"
          >
            <template #content>
          ...
          />
          <span
            v-if="groupDialog.announcement.editorId"
            style="margin-right: 6px"
          >
          ...
          <template
            v-if="
              hasGroupPermission(groupDialog.ref, 'group-announcement-manage')
            "
          >
            <TooltipWrapper
              side="top"
    ...
    >
      <div class="flex-1 overflow-hidden">
        ...
        <pre
          class="text-xs font-[inherit] whitespace-pre-wrap mr-2 my-0 ml-0"
    ...
    >
      <div class="flex-1" style="overflow: visible">
        ...
        <template v-if="upcomingCalenderEvents.length > 0">
          <br />
          <div
            class="grid-view flex flex-wrap gap-4 overflow-y-auto max-h-[360px] py-2.5"
          >
    ...
    <div class="inline-flex justify-between w-full">
      <div
        class="box-border flex items-center p-1.5 text-[13px] cursor-default w-1/2"
      >
        <div class="flex-1 overflow-hidden">
          <span class="block truncate font-medium leading-[18px]">{{
...
<script setup>
import { Copy, Eye, Image, MoreHorizontal } from "lucide-vue-next";
